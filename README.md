...
***We expose this user-friendly algorithm library (with a simulation platform for evaluation) for beginners who intend to start federated learning (FL) study.***
