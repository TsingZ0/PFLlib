...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"Cifar10_{args.partition}_{args.alpha}_{args.balance}_{args.num_users}/"
    ...
    trainset = torchvision.datasets.CIFAR10(
        root="rawdata/Cifar10", train=True, download=True, transform=transform)
    testset = torchvision.datasets.CIFAR10(
        root="rawdata/Cifar10", train=False, download=True, transform=transform)
