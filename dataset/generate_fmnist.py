...
def generate_fmnist(dir_path, num_clients, num_classes, niid=False, real=True, partition=None):
...
if __name__ == "__main__":
    ...
    generate_fmnist(dir_path, num_clients, num_classes, niid, real, partition)