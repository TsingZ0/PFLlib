...
def generate_fmnist(dir_path, num_clients, num_labels, niid=False, real=True, partition=None):
...
if __name__ == "__main__":
    ...
    generate_fmnist(dir_path, num_clients, num_labels, niid, real, partition)