...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"Flowers102_{args.partition}_{args.alpha if args.partition == 'dir' else args.class_per_client}_{args.balance}_{args.num_users}/"
    ...
    def load_data(split="train"):
        trainset = torchvision.datasets.Flowers102(
            root="rawdata/Flowers102", split=split, download=True, transform=transform)
