...
random.seed(1)
np.random.seed(1)
data_path_train = "../leaf-master/data/shakespeare/data/train/all_data_niid_2_keep_0_train_9.json"
data_path_test = "../leaf-master/data/shakespeare/data/train/all_data_niid_2_keep_0_train_9.json"
