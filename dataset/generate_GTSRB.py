...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"GTSRB_{args.partition}_{args.alpha if args.partition == 'dir' else args.class_per_client}_{args.balance}_{args.num_users}/"
    ...
    def load_data(split="train"):
        trainset = torchvision.datasets.GTSRB(
            root="rawdata/GTSRB", split=split, download=True, transform=transform)
