...
def generate_mnist(dir_path=dir_path, num_clients=num_clients, num_labels=num_labels, niid=False, real=True):
...
if __name__ == "__main__":
    ...
    generate_mnist(dir_path=dir_path, num_clients=num_clients, num_labels=num_labels, niid=niid, real=real)