...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"MNIST_{args.partition}_{args.alpha}_{args.balance}_{args.num_users}/"
    ...
    trainset = torchvision.datasets.MNIST(
        root="rawdata/MNIST", train=True, download=True, transform=transform)
    testset = torchvision.datasets.MNIST(
        root="rawdata/MNIST", train=False, download=True, transform=transform)
