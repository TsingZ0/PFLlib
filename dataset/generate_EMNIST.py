...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"EMNIST_{args.partition}_{args.alpha if args.partition == 'dir' else args.class_per_client}_{args.balance}_{args.num_users}/"
    ...
    trainset = torchvision.datasets.EMNIST(
        root="rawdata/EMNIST", split='digits', train=True, download=True, transform=transform)
    testset = torchvision.datasets.EMNIST(
        root="rawdata/EMNIST", split='digits', train=False, download=True, transform=transform)
